                        ...
                        <div class="archiveNotice__textWrap">
                            <div class="archiveNotice__textInner">
                                <div class="archiveNotice__dcWrap">
                                    ...
                                    <span class="archiveNotice__tag">
                                        <?php
                                        $terms = get_the_terms(get_the_ID(), 'notice_tag');
                                        if (! empty($terms) && ! is_wp_error($terms)) {
                                            echo '<div class="post-notice_tag">';
                                            foreach ($terms as $term) {
                                                echo '<span class="cat-name">' . esc_html($term->name) . '</span>';
                                            }
                                            echo '</div>';
                                        }
                                        ?>
                                    </span>
                                    <span class="archiveNotice__category">
                                        <?php
                                        $terms = get_the_terms(get_the_ID(), 'notice_category');
                                        if (! empty($terms) && ! is_wp_error($terms)) {
                                            echo '<div class="post-notice_category">';
                                            foreach ($terms as $term) {
                                                echo '<span class="cat-name">' . esc_html($term->name) . '</span>';
                                            }
                                            echo '</div>';
