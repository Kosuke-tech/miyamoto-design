...
<section class="work archiveWork">
    ...
    <div class="work__wrapper blContainer" id="target_page-work">
        <div class="work__inner archiveWork__inner">
            <div class="work__headingWrap archiveWork__headingWrap heading">
                <h2 class="work__headingEn archiveWork__headingEn heading__en">Work</h2>
        ...
        <div class="work__contentsWrap archiveWork__contentsWrap">
            ...
            if ($work_query->have_posts()) :
                while ($work_query->have_posts()) : $work_query->the_post(); ?>
                    ...
                    <a class="work__cardWrap archiveWork__cardWrap" href="<?php the_permalink(); ?>">
                        <div class="work__thumbnailWrap archiveWork__thumbnailWrap">
